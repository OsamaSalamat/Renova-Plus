...
$host='localhost'; $db='trade_offer_pro'; 
$user='root'; 
$pass=''; 
$charset='utf8mb4';
...
catch(PDOException $e){http_response_code(500);exit('Database unavailable. Import database/database.sql and check config/database.php.');}
